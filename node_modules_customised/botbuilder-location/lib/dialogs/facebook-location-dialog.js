...
// Added this so that we can fall back to default dialog
// ===================================================================
var defaultDialog = require('./default-location-dialog');
// ===================================================================
...
// Copied this across from default-location-dialog
// ===================================================================
...
function createLocationResolveDialog(apiKey) {
    return common.createBaseDialog()
        ...
        session.send('OK searching for ' + session.message.text + '...');
        var searchString = session.message.text + ", NYC";        
        locationService.getLocationByQuery(apiKey, searchString)
            .then(function (locations) {
            ...
            session.send('Found ' + locationCount + ' results...');
            var reply = createLocationsCard(apiKey, session, locations);
            session.send('Creating options...');
            session.send(reply);            
...
// Copied these two methods across from default-location-dialog
// ===================================================================
...
function constructCard(apiKey, session, locations, index) {
    ...
    if (locations.length > 1) {
        ...
        //console("default-location-dialog.constructCard index + 1 = " + (index + 1));
    }
    else {
